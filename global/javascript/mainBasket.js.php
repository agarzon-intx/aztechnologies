...
function abrirFichaBasket(id, week, game, gamedesc, lgoals, vgoals){
	...
	if (typeof attr == typeof undefined) {
		...
		$.ajax({
			type: 'POST',
			dataType: 'json',
			url: 'ajax/Content/week-ScheduleScoresGameDetailBasket.php',
...
function abrirFichaSBasket(id, week, game, gamedesc, lgoals, vgoals){
	//console.log('abrirFicha');
	...
	if (typeof attr == typeof undefined) {
		...
		$.ajax({
			type: 'POST',
			dataType: 'json',
			url: 'ajax/Content/week-ScheduleScoresGameDetailSBasket.php',
			data: {week: week, game: game, gamedesc: gamedesc, lgoals: lgoals, vgoals: vgoals},
			success: function (res) {
				mainLoadingOff()
				if (res.status === '1') {
...
function abrirFichaEditBasket(id, week, game, gamedesc, lgoals, vgoals, Arbitro, Comentarios, Extral, Extrav, SQL){
	...
	if (typeof attr == typeof undefined) {
		...
		$.ajax({
			type: 'POST',
			dataType: 'json',
			url: 'ajax/Admin/Games/weekAdmin-ScheduleScoresGameDetailBasket.php',
...
function abrirFichaEditSBasket(id, week, game, gamedesc, lgoals, vgoals, Arbitro, Comentarios, Extral, Extrav, SQL){
	...
	if (typeof attr == typeof undefined) {
		...
		$.ajax({
			type: 'POST',
			dataType: 'json',
			url: 'ajax/Admin/Games/weekAdmin-ScheduleScoresGameDetailSBasket.php',
			data: {week: week, game: game, gamedesc: gamedesc, lgoals: lgoals, vgoals: vgoals, Arbitro: Arbitro, Comentarios: Comentarios, Extral: Extral, Extrav: Extrav, SQL: SQL},
			success: function (res) {
				mainLoadingOff()
				if (res.status === '1') {
