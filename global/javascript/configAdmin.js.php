...
unset($__i, $__prev, $__base, $__inc, $__app_here);
	...
	echo "
		...
		function validateGeneral(){
			...
			var duplicatePlayer = 0;
			if ($('#duplicatePlayer').is(':checked')){
			  duplicatePlayer = 1;
			}
			var searchPlayer = 0;
			if ($('#searchPlayer').is(':checked')){
			  searchPlayer = 1;
			}
			var currentWeek = 0;
