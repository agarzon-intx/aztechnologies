...
unset($__i, $__prev, $__base, $__inc, $__app_here);
	...
	$sessionstat = $fgmembersite->CheckLogin('alta.js.php');
	...
	echo "	function printID1(){
			...
			function validate(srccat, srcteam){
            ...
            function playersManagementValidateAllPlayers(cat, srcteam){
                playersManagementAdminValidateAll(cat, srcteam);
            }

			function validateTeam(srcteam){
				var error = \"" . $lang['js0000'] . "\";
				var count = 0;
				var curp = '';
				if($('#nombre').val().length == 0){
			...
			function limpiar(){
				...
				$('#playersManagementCreate').html('');
			}

			function limpiarE(){
				$('#playersManagementList').toggle();
				$('#playersManagementEdit').toggle();
				$('#playersManagementEdit').html('');
			}
			
			function validateE(playerid, srccat, srcteam){
				var error = \"" . $lang['js0000'] . "\";
				var count = 0;
				var curp = '';
			...
			function validateETeam(playerid, srcteam){
				var error = \"" . $lang['js0000'] . "\";
				var count = 0;
				var curp = '';
				if($('#nombreE').val().length == 0){
			...
			function updatePrintListS(){
				var list = '';
				var count = 0;
				$('.playersManagementAdminImprimirUpdateS').each(function(index ) {
					if ($( this ).is(':checked')){
						if(count === 0){
							list = $( this ).val();
						}else{
