								...
								<td colspan=3" style="text-align:left; border: none; width: 100%">
									<div class="row">
										...
										<div class="col-2 col-sm-2 col-md-2 col-lg-2 col-xl-2">
											...
											<button style="margin-top: -5px; margin-bottom: 15px;" type="button" class="btn btn-primary" onclick="SaveGameDetailPlayerStatsR(' . $Season . ',' . $Week . ',' . $Game . ',' . $lequipoid . ',' . $vequipoid . ', \'\', $(\'#comentario' . $Game . '\').val(), 0, 0);">' . $lang['0000'] . '</button>
											</div>
										</div>
									</div>
								</td>
