...
unset($__i, $__prev, $__base, $__inc, $__app_here);
	...
	$sessionstat = $fgmembersite->CheckLogin('CategoriesManagement.php');
	...
	$htmlCategory .= '<div id="categoriessManagement" class="tabla active" style="display: block;padding-top: 10px;">
	...
	/*-----------------------------------------------------------------------------------------------------------------------------
	-----------------------------------------------------------------------------------------------------------------------------*/
	$htmlCategory .= '<div id="categoriesManagementList" class="tabla active" style="display: block; height: auto;">';
	require 'CategoriesManagementActiveList.php';
	$htmlCategory .= '</div>';
	/*-----------------------------------------------------------------------------------------------------------------------------
	-----------------------------------------------------------------------------------------------------------------------------*/
	...
	/*-----------------------------------------------------------------------------------------------------------------------------
	-----------------------------------------------------------------------------------------------------------------------------*/
	$htmlCategory .= '<div id="categoriesManagementCreate" class="tabla" style="display: none; height: auto;">';
	$htmlCategory .= '</div>';
	/*-----------------------------------------------------------------------------------------------------------------------------
	-----------------------------------------------------------------------------------------------------------------------------*/
	...
	/*-----------------------------------------------------------------------------------------------------------------------------
	-----------------------------------------------------------------------------------------------------------------------------*/
	$htmlCategory .= '<div id="categoriesManagementEdit" class="tabla" style="display: none; height: auto;">';
	$htmlCategory .= '</div>';
	/*-----------------------------------------------------------------------------------------------------------------------------
	-----------------------------------------------------------------------------------------------------------------------------*/
	$htmlCategory .= "</div> 
    ...
    $retunData = array('status' => '1', 'message' => 'Success.', 'dataCategory' => $htmlCategory);
    $Config->Close();
