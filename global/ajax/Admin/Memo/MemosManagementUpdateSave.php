...
unset($__i, $__prev, $__base, $__inc, $__app_here);
	...
	$sessionstat = $fgmembersite->CheckLogin('MemosManagementUpdateSave.php');
	...
	$retunData = array('status' => '0', 'message' => 'No insert.', 'dataMemoAnswer' => 'Error');
		
	$sql1 = "CALL $schema.MemoUpdate('" . $_SESSION[$Config->getAlias() . 'username'] . "', $id, '$Titulo', '$Fecha', '$minuta', @out);";
	...
	if ($result->num_rows > 0) {
		...
		while($row2 = $result->fetch_assoc()) {
			$retunData = array('status' => '1', 'message' => 'Success.', 'dataMemoAnswer' => $lang['720'], 'sql1' => $sql1, 'sql2' => $sql2);
		}
	}
