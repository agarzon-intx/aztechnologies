...
if (!defined('APP_SITE_ROOT')) {
	...
	$sql = "CALL $schema.PlayerTeamUpdate('" . $_SESSION[$Config->getAlias() . 'username'] . "', $playerid, '$name', '$lastname', '$lastname2', '$nickname', '$birthdate', '$status', '$id', '$playernumber', $team, '$valid', '$comments', '$phone', '$email','$foto','$idfull','$firma',$sex, $type, NOW(), @out);";
	//echo $sql;
	...
	if ($result->num_rows > 0) {
		...
		while($row2 = $result->fetch_assoc()) {
			$retunData = array('status' => '1', 'message' => 'Success.', 'dataPlayerMessage' => $lang['938'], 'sql' => $sqlt);
		}
	}
	$Connection->Close();
