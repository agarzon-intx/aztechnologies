						...
						<div class="col-xl-4" style="text-align: center;">
							...
							<div class="row" style="width: 100%;">
								<div class="form-check col-12 col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">
									...
									<div class="row">
										<div class="form-check col-12 col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">';
    $sql3 = "SELECT c.Categoria_ID, b.Equipo_ID, concat(c.categoria_DESC,' - ',b.Equipo_FULLDESC) Equipo_FULLDESC, concat(b.Torneo_ID,'-', b.Equipo_ID) Logo 
    		from (	select a.* 
													...
													<div class="row">
														<div class="col-12 col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">
															<div class="input-group input-group-outline my-3" style="margin-top: 5px !important;margin-bottom: 0px !important;">
																...
																<input type="text" class="form-control" name="apodo" id="apodo" value="" ' . $apodoenable . '>
															</div>
														</div>
													</div>
													<div class="row">
													...
													<div class="row">
														<div class="col-12 col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">
															<div class="input-group input-group-outline my-3" style="margin-top: 5px !important;margin-bottom: 0px !important;">
																...
																<select disabled class="form-control" onChange="playerManagementLoadImage(\'equipo\', \'logoE\')" name="equipo" id="equipo" >';
$sql4 = "SELECT c.Categoria_ID, b.Equipo_ID, concat(c.categoria_DESC,' - ',b.Equipo_FULLDESC) Equipo_FULLDESC, concat(b.Torneo_ID,'-', b.Equipo_ID) Logo
	from (	select a.* 
			from $schema.Equipos a
			where Equipo_ID > 0 
				and Torneo_ID = $Season) b
...
$htmlPlayer .= '													</select>
													...
													<div class="row">
														<div class="col-12 col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">
															<div class="input-group input-group-outline my-3" style="margin-top: 5px !important;margin-bottom: 0px !important;">
																...
																<select disabled class="form-control" name="Validado" id="Validado">
								...
								<div class="form-check col-12 col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">
									<span style="text-align: center; ">
										<div style="width: 150px; height: 60px; background-color: #BFBFBF; margin: auto;">
											<img width="150" height="60" id="firma" src="" alt="" style="display: none"/>
										</div>
									</span>
								</div>
							</div>
				...
				<div class="row">
					<div class="col-6 col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6 col-xxl-6" style="text-align: right;">
						<button type="button" class="btn btn-primary" onClick="validateTeam(' . $Team . ');" >' . $lang['0000'] . '</button>
					</div>
	...
	$retunData = array('status' => '1', 'message' => 'Success.', 'dataPlayerAdd' => $htmlPlayer, 'slq3' => $sql3, 'slq4' => $sql4);
    $Config->Close();
