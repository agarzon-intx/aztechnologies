...
if ($result2 && $result2->num_rows > 0) {
	while($row2 = $result2->fetch_assoc()) {
		...
		$htmlTeams .=	'<td scope="row" class="align-middle text-center"><span class="text-secondary text-xs font-weight-normal"><input type="checkbox" class="teamsManagementSelect" data-scope="inactive" name="teamsManagementSelect' . (int) $row2["Equipo_ID"] . '" id="teamsManagementSelectInactive' . (int) $row2["Equipo_ID"] . '" value="' . (int) $row2["Equipo_ID"] . '"/></span></td>
		...
		$htmlTeams .= '<td scope="row" style="padding-top: 0.35rem; padding-bottom: 0.35rem;">
							<div class="d-flex flex-wrap px-0 py-0 w-100" style="min-width:0;">
								<div style="flex: 0 0 10%; max-width:10%; min-width:0; text-align: center; padding-top: 0.5rem;">
									<input type="checkbox" class="teamsManagementSelect" data-scope="inactive" name="teamsManagementSelectM' . (int) $row2["Equipo_ID"] . '" id="teamsManagementSelectInactiveM' . (int) $row2["Equipo_ID"] . '" value="' . (int) $row2["Equipo_ID"] . '"/>
								</div>
