...
unset($__i, $__prev, $__base, $__inc, $__app_here);
	...
	$sessionstat = $fgmembersite->CheckLogin('colorsManagement.php');
	...
	$htmlColor .= '<div id="colorsManagement" class="tabla active" style="display: block;padding-top: 10px;">
	...
	/*-----------------------------------------------------------------------------------------------------------------------------
	-----------------------------------------------------------------------------------------------------------------------------*/
	$htmlColor .= '<div id="colorsManagementList" class="tabla active" style="display: block; height: auto;">';
	require 'colorsManagementActiveList.php';	
	$htmlColor .= '</div>';            
	/*-----------------------------------------------------------------------------------------------------------------------------
	-----------------------------------------------------------------------------------------------------------------------------*/
	...
	/*-----------------------------------------------------------------------------------------------------------------------------
	-----------------------------------------------------------------------------------------------------------------------------*/
	$htmlColor .= '<div id="colorsManagementCreate" class="tabla" style="display: none; height: auto;">';
	//require 'colorsManagementCreate.php';	
	$htmlColor .= '</div>';            
	/*-----------------------------------------------------------------------------------------------------------------------------
	-----------------------------------------------------------------------------------------------------------------------------*/
	...
	/*-----------------------------------------------------------------------------------------------------------------------------
	-----------------------------------------------------------------------------------------------------------------------------*/
	$htmlColor .= '<div id="colorsManagementEdit" class="tabla" style="display: none; height: auto;">';
	$htmlColor .= '</div>';            
	/*-----------------------------------------------------------------------------------------------------------------------------
	-----------------------------------------------------------------------------------------------------------------------------*/
	$htmlColor .= "</div> 
    ...
    $retunData = array('status' => '1', 'message' => 'Success.', 'dataColor' => $htmlColor);
    $Config->Close();
