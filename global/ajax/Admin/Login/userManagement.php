...
unset($__i, $__prev, $__base, $__inc, $__app_here);
	...
	$sessionstat = $fgmembersite->CheckLogin('userManagement.php');
	...
	$htmlUsers .= '<div id="userManagement" class="tabla active" style="display: block;padding-top: 10px;">
	...
	/*-----------------------------------------------------------------------------------------------------------------------------
	-----------------------------------------------------------------------------------------------------------------------------*/
	$htmlUsers .= '<div id="userManagementList" class="tabla active" style="display: block; height: auto;">';
	require 'userManagementPrintList.php';	
	$htmlUsers .= '</div>';            
	/*-----------------------------------------------------------------------------------------------------------------------------
	-----------------------------------------------------------------------------------------------------------------------------*/
	...
	/*-----------------------------------------------------------------------------------------------------------------------------
	-----------------------------------------------------------------------------------------------------------------------------*/
	$htmlUsers .= '<div id="userManagementCreate" class="tabla" style="display: none; height: auto;">';
	$htmlUsers .= '</div>';            
	/*-----------------------------------------------------------------------------------------------------------------------------
	-----------------------------------------------------------------------------------------------------------------------------*/
	...
	/*-----------------------------------------------------------------------------------------------------------------------------
	-----------------------------------------------------------------------------------------------------------------------------*/
	$htmlUsers .= '<div id="userManagementEdit" class="tabla" style="display: none; height: auto;">';
	$htmlUsers .= '</div>';            
	/*-----------------------------------------------------------------------------------------------------------------------------
	-----------------------------------------------------------------------------------------------------------------------------*/
	$htmlUsers .= '</div> 
    ...
    $retunData = array('status' => '1', 'message' => 'Success.', 'dataUser' => $htmlUsers, 'sql0' => $sql0, 'sql1' => $sql1, 'sql2' => $sql2);
    $Config->Close();
