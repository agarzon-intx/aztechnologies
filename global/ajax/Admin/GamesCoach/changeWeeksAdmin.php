...
unset($__i, $__prev, $__base, $__inc, $__app_here);
	...
	$currentWeek = 0;
	$weekDateExpr = 'DATE_ADD(CURDATE(), INTERVAL 8 - WEEKDAY(CURDATE()) DAY)';
	if ((int) $Config->currentWeek === 1) {
		$weekDateExpr = 'CURDATE()';
	}
	$sql0 = "select distinct j.Jornada_ID as Jornada, j.Jornada_Desc
			...
			where j.Torneo_ID = $Season and $weekDateExpr between Fecha_Inicio and Fecha_Fin
