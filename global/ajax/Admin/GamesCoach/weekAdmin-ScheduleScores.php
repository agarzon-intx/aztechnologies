            ...
            $sqlJuegosXNombre = " and (Local_Id in (" . $_SESSION[$Config->getAlias() . 'equipo'] . ") or Visitante_ID in (" . $_SESSION[$Config->getAlias() . 'equipo'] . "))";
            $sqlcat = "";
			...
			$sql2 = "select * from (
            						...
            						where j.Jornada_ID = $Week and Visitante_ID is not null $sqlcat $sqlJuegosXNombre and (Local_Id in (" . $_SESSION[$Config->getAlias() . 'equipo'] . ") or Visitante_ID in (" . $_SESSION[$Config->getAlias() . 'equipo'] . "))
            						UNION
				...
				$htmlWeek .= '	<tr>
									<td style="border-bottom: 0;" colspan="2">
										<button type="button" class="btn btn-primary" onclick="saveChangesC(' . $Season . ',' . $Week . ');">' . $lang['0000'] . '</button>
									</td>
				...
				$htmlWeek .= '	<tr>
									<td style="border-bottom: 0;">
										<button type="button" class="btn btn-primary" onclick="saveChangesSC(' . $Season . ',' . $Week . ');">' . $lang['0000'] . '</button>
									</td>
								</tr>';
