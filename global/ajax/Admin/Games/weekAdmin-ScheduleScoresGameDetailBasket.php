									...
									<div class="row">
										...
										<div class="col-1 col-sm-1 col-md-1 col-lg-1 col-xl-1">
											<div style="text-align:left; border: none; margin-top: 10px !important">
												<button style="margin-top: -5px; margin-bottom: 15px;" type="button" class="btn btn-primary" onclick="SaveGameDetailPlayerStatsBasket(' . $Season . ',' . $Week . ',' . $Game . ',' . $lequipoid . ',' . $vequipoid . ', $(\'#arbitro\').val(), $(\'#comentario\').val(), $(\'#extral\').val(), $(\'#extrav\').val());">' . $lang['0000'] . '</button>
											</div>
										</div>
									</div>
								</td>
