									...
									<div class="row">
										...
										<div class="col-4 col-sm-4 col-md-4 col-lg-4 col-xl-4">
											<div style="text-align:left; border: none; margin-top: 10px !important">
												<button style="margin-top: -5px; margin-bottom: 15px;" type="button" class="btn btn-primary" onclick="SaveGameDetailPlayerStatsSBasket(' . $Season . ',' . $Week . ',' . $Game . ',' . $lequipoid . ',' . $vequipoid . ', $(\'#arbitroS\').val(), $(\'#comentarioS\').val(), $(\'#extralS\').val(), $(\'#extravS\').val());">' . $lang['0000'] . '</button>
											</div>
										</div>
									</div>
								</td>
