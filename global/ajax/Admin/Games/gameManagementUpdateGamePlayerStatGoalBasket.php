...
unset($__i, $__prev, $__base, $__inc, $__app_here);
	...
	$sessionstat = $fgmembersite->CheckLogin('gameManagementUpdateGamePlayerStatGoal.php');
    ...
    $Goals1 = SanitizeInteger($_POST['Goals1']);
    $Goals2 = SanitizeInteger($_POST['Goals2']);
    $Goals3 = SanitizeInteger($_POST['Goals3']);

	$retunData = array('status' => '0', 'message' => 'No insert.', 'dataColorAnswer' => 'Error');
		
	$sql = "CALL $schema.GameUpdateDetailGoalsBasket('" . $_SESSION[$Config->getAlias() . 'username'] . "', $Player, $Team, $Game, $Week, $Season, $Goals1, $Goals2, $Goals3, @out);";
