...
unset($__i, $__prev, $__base, $__inc, $__app_here);
	...
	$sessionstat = $fgmembersite->CheckLogin('AlertsManagementCreate.php');
	...
	$htmlAlerts .= '<div class="container-fluid py-2">
						...
						<div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
							<form>
								<div class="row">
									...
									<div class="col-xl-12">
										<textarea cols="80" rows="20" id="editor" name="editor">' . $Config->LoadAvisoTemplate() . '</textarea>
										<script>
					...
					<div class="row">
						<div class="my-3" >
							<button type="button" class="btn btn-primary" onClick="validateAlertCreate();" >' . $lang['0000'] . '</button>
							<button type="button" class="btn btn-primary" onClick="alertManagementHideAdd();" >' . $lang['0001'] . '</button>
						</div>
					</div>
				</div>
				<script>
	...
	$retunData = array('status' => '1', 'message' => 'Success.', 'alertAdd' => $htmlAlerts);
