...
unset($__i, $__prev, $__base, $__inc, $__app_here);
	...
	$sessionstat = $fgmembersite->CheckLogin('UploadSignatureE.php');
	...
	if(isset($_POST) and $_SERVER['REQUEST_METHOD'] == "POST"){
		$name = $_FILES['myFirmaE']['name'];
		if(strlen($name)) {
			list($txt, $ext) = explode(".", $name);
			$image_name = "signaturePicture-" . session_id() .".".$ext;
			$tmp = $_FILES['myFirmaE']['tmp_name'];
			//echo $path;
