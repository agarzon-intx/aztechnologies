<?php
				...
				$htmlWeek .= '<th scope="col" class="text-center text-uppercase text-secondary text-s font-weight-bolder opacity-7" style="padding: 0.75rem 0.5rem;"><img src="./imagenes/Pointb1.png" width="20" height="20" alt=""></th>';
				$htmlWeek .= '<th scope="col" class="text-center text-uppercase text-secondary text-s font-weight-bolder opacity-7" style="padding: 0.75rem 0.5rem;"><img src="./imagenes/Pointb2.png" width="20" height="20" alt=""></th>';
				$htmlWeek .= '<th scope="col" class="text-center text-uppercase text-secondary text-s font-weight-bolder opacity-7" style="padding: 0.75rem 0.5rem;"><img src="./imagenes/Pointb3.png" width="20" height="20" alt=""></th>';
				$htmlWeek .= '</thead>';
				$htmlWeek .= '<tbody>';
				
				
				$Config->query("SET @rank:=0;");
				$sql2 = "SELECT @rank:=@rank+1 AS rank, a.* from (select Numero, concat(b.Nombre,' ', b.Apellido_P, ' ', b.Apellido_M) Jugador, c.Equipo_DESC, concat(c.Torneo_ID,'-', c.Equipo_ID) Logo, ifnull(sum(a.Puntos1),0) as Puntos1,
				ifnull(sum(a.Puntos2),0) as Puntos2, ifnull(sum(a.Puntos3),0) as Puntos3
						from $schema.PuntosB a
					...
					if ($result2->num_rows > 0) {
						...
						while($row2 = $result2->fetch_assoc()) {
							...
							$htmlWeek .= '<td scope="row" class="align-middle text-center"><span class="text-secondary text-xs font-weight-normal">' . $row2["rank"]. '</span></td>
											...
											<td scope="row" class="align-middle text-center"><span class="text-secondary text-xs font-weight-normal">' . $row2["Puntos1"]. '</span></td>
											<td scope="row" class="align-middle text-center"><span class="text-secondary text-xs font-weight-normal">' . $row2["Puntos2"]. '</span></td>
											<td scope="row" class="align-middle text-center"><span class="text-secondary text-xs font-weight-normal">' . $row2["Puntos3"]. '</span></td>';
							$htmlWeek .= '</tr>';
							$count++;
						}
					}
				...
				$htmlWeek .= '<th scope="col" class="text-center text-uppercase text-secondary text-s font-weight-bolder opacity-7" style="padding: 0.15rem 0.1rem;"><img src="./imagenes/Pointb1.png" width="20" height="20" alt=""></th>';
				$htmlWeek .= '<th scope="col" class="text-center text-uppercase text-secondary text-s font-weight-bolder opacity-7" style="padding: 0.15rem 0.1rem;"><img src="./imagenes/Pointb2.png" width="20" height="20" alt=""></th>';
				$htmlWeek .= '<th scope="col" class="text-center text-uppercase text-secondary text-s font-weight-bolder opacity-7" style="padding: 0.15rem 0.1rem;"><img src="./imagenes/Pointb3.png" width="20" height="20" alt=""></th>';
				$htmlWeek .= '</thead>';
				$htmlWeek .= '<tbody>';
