...
$schema = $Config->getSchema();
	$sessionstat = $fgmembersite->CheckLogin('RefereeManagement.php');
	...
	$htmlReferee .= '<div id="refereeManagement" class="tabla active" style="display: block;padding-top: 10px;">
	...
	/*-----------------------------------------------------------------------------------------------------------------------------
	-----------------------------------------------------------------------------------------------------------------------------*/
	$htmlReferee .= '<div id="refereeManagementList" class="tabla active" style="display: block; height: auto;">';
	require 'RefereeManagementActiveList.php';
	$htmlReferee .= '</div>';
	/*-----------------------------------------------------------------------------------------------------------------------------
	-----------------------------------------------------------------------------------------------------------------------------*/
	...
	/*-----------------------------------------------------------------------------------------------------------------------------
	-----------------------------------------------------------------------------------------------------------------------------*/
	$htmlReferee .= '<div id="refereeManagementCreate" class="tabla" style="display: none; height: auto;">';
	$htmlReferee .= '</div>';
	/*-----------------------------------------------------------------------------------------------------------------------------
	-----------------------------------------------------------------------------------------------------------------------------*/
	...
	/*-----------------------------------------------------------------------------------------------------------------------------
	-----------------------------------------------------------------------------------------------------------------------------*/
	$htmlReferee .= '<div id="refereeManagementEdit" class="tabla" style="display: none; height: auto;">';
	$htmlReferee .= '</div>';
	/*-----------------------------------------------------------------------------------------------------------------------------
	-----------------------------------------------------------------------------------------------------------------------------*/
	$htmlReferee .= "</div> 
    ...
    $retunData = array('status' => '1', 'message' => 'Success.', 'datareferee' => $htmlReferee);
    $Config->Close();
