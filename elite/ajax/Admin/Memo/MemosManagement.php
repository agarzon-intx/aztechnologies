...
unset($__i, $__prev, $__base, $__inc, $__app_here);
	...
	$sessionstat = $fgmembersite->CheckLogin('MemosManagement.php');
	...
	$htmlMemos .= '<div id="memosManagement" class="tabla active" style="display: block;padding-top: 10px;">
	...
	/*-----------------------------------------------------------------------------------------------------------------------------
	-----------------------------------------------------------------------------------------------------------------------------*/
	$htmlMemos .= '<div id="memosManagementList" class="tabla active" style="display: block; height: auto;">';
	require 'MemosManagementActiveList.php';
	$htmlMemos .= '</div>';
	/*-----------------------------------------------------------------------------------------------------------------------------
	-----------------------------------------------------------------------------------------------------------------------------*/
	...
	/*-----------------------------------------------------------------------------------------------------------------------------
	-----------------------------------------------------------------------------------------------------------------------------*/
	$htmlMemos .= '<div id="memosManagementCreate" class="tabla" style="display: none; height: auto;">';
	$htmlMemos .= '</div>';
	/*-----------------------------------------------------------------------------------------------------------------------------
	-----------------------------------------------------------------------------------------------------------------------------*/
	...
	/*-----------------------------------------------------------------------------------------------------------------------------
	-----------------------------------------------------------------------------------------------------------------------------*/
	$htmlMemos .= '<div id="memosManagementEdit" class="tabla" style="display: none; height: auto;">';
	$htmlMemos .= '</div>';
	/*-----------------------------------------------------------------------------------------------------------------------------
	-----------------------------------------------------------------------------------------------------------------------------*/
	$htmlMemos .= "</div> 
    ...
    $retunData = array('status' => '1', 'message' => 'Success.', 'dataMemo' => $htmlMemos);
    $Config->Close();
