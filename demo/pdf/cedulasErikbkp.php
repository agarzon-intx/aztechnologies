<?php
	...
	if ($result1 && $result1->num_rows > 0) {
		...
		while($row1 = $result1->fetch_assoc()) {
			...
			$pdf->Cell(60 , 5, az_utf8_decode($row1["Fecha_String"]) . '  ' . az_utf8_decode($row1["Horario"]) , 1, 1 , 'L' , false);
             /*Torneo y Categoria */
           	$pdf->SetFont('Helvetica' , '' , 12);
			$pdf->SetTextColor(0, 0, 0);
			$pdf->SetXY(5,10);
            ...
            $pdf->Cell(98, 16, $Config->liga, 1, 1 , 'C' , false);
           ...
           // $pdf->Image('fmvb.png', 10, 10, -300);
	    	...
	    	$pdf->SetXY(115,13);
	    	$pdf->MultiCell(30, 4, az_utf8_decode($row1["Local"]), 0 , 'C' , false);
	    	$pdf->SetXY(145,13);
	    	$pdf->MultiCell(30, 4, az_utf8_decode($row1["Visitante"]), 0 , 'C' , false);
		   ...
		   /*Cancha y Juego */
		    ...
		    $pdf->SetXY(27,21);
		    $pdf->Cell(38 , 6, 'A) ' . az_utf8_decode($row1["Local"]), 1, 1 , 'L' , false);
		...
		/*
			$pdf->Cell(40 , 5, mb_strtoupper(az_utf8_decode('' . az_utf8_decode($row1["Local"]) . '')), 1, 1 , 'C' , false);
		...
		/*	
			...
			$pdf->Cell(90 , 3, $lang['986'] . ' ' . az_utf8_decode($row1["Jornada_DescCorta"]) . '', 35, 0 , 'L' , false);
			$pdf->SetXY(40,35);
			...
			*/
			...
			$pdf->SetXY(84,21);
            $pdf->SetFont('Times' , 'B' , 9);
			$pdf->Cell(38, 6, 'B) ' . az_utf8_decode($row1["Visitante"]), 1, 0 , 'L' , false);
	     ...
	     /*Titulo Termina */
	       $pdf->SetFont('Times' , 'B' , 6);
	        ...
	        $pdf->SetXY(158,21);
            $pdf->SetFont('Times' , 'B' , 8);
			$pdf->Cell(35 , 6, 'B) ' . az_utf8_decode($row1["Visitante"]), 1, 0 , 'L' , false);
	     ...
	     /*Colocacion del equipo dentro de la cancha 2do set*/
		    $pdf->SetFont('Times' , 'B' , 9);
		    $pdf->SetXY(211,21);
		    $pdf->Cell(35 , 6, 'A) ' . az_utf8_decode($row1["Local"]), 1, 1 , 'L' , false);
	     ...
	     /*Dato de R=Recibe, S= Al servicio Local 2do set*/
            ...
            $pdf->SetFont('Helvetica' , 'B' , 8);
            $pdf->SetTextColor(0, 0, 0);
	    	$pdf->Cell(14.5, 6, $lang['370'] , 1, 0 , 'C' , false);
...
/*			$pdf->SetXY(118,30);
			...
			$pdf->Cell(90 , 8, $lang['0'] . ': "' . az_utf8_decode($row1["Torneo_Desc"]) . '"', 35, 0 , 'L' , false);
			$pdf->SetXY(118,34);
			$pdf->SetFont('Helvetica' , 'B' , 10);
			$pdf->Cell(90 , 8, $lang['1'] . ': "' . az_utf8_decode($row1["Categoria_DESC"]) . '"', 35, 0 , 'L' , false);
			$pdf->SetFont('Helvetica' , '' , 10);
			$pdf->SetXY(195, 32);
		...
		/*	$pdf->SetFont('Times' , 'B' , 9);
			...
			$pdf->Cell(128 , 5, mb_strtoupper(az_utf8_decode('' . az_utf8_decode($row1["Local"]) . '')), 1, 1 , 'C' , false);*/
		...
		/*	$pdf->SetXY($x+22,$y+30.5);
		  ...
		  /* Puntos Equipo Local 1er. set*/
           ...
           $pdf->SetXY(68,27);
	    	...
	    	$pdf->SetXY(68,56.6);
			$pdf->Cell(4 , 3.2,$lang['10519'], 0, 0 , 'C' , false);
			$pdf->SetXY(72,56.6);
			$pdf->Cell(4 , 3.2,$lang['10530'], 0, 0 , 'C' , false);
			$pdf->SetXY(76,56.6);
			$pdf->Cell(4 , 3.2,$lang['10541'], 0, 0 , 'C' , false);
			$pdf->SetXY(80,56.6);
			$pdf->Cell(4 , 3.2,$lang['10552'], 0, 0 , 'C' , false);
			
			$pdf->SetXY(68,59.7);
			$pdf->Cell(4 , 3.2,$lang['10520'], 0, 0 , 'C' , false);
			$pdf->SetXY(72,59.7);
			$pdf->Cell(4 , 3.2,$lang['10531'], 0, 0 , 'C' , false);
			$pdf->SetXY(76,59.7);
			$pdf->Cell(4 , 3.2,$lang['10542'], 0, 0 , 'C' , false);
			$pdf->SetXY(80,59.7);
			$pdf->Cell(4 , 3.2,$lang['10553'], 0, 0 , 'C' , false);
...
/* Puntos Equipo Visitante 1er. set*/
		    ...
		    $pdf->SetFont('Times' , '' , 6);
              $pdf->SetXY(132,27);
			$pdf->Cell(3.7 , 3.4,$lang['10509'], 0, 0 , 'C' , false);
			$pdf->SetXY(135.7,27);
			$pdf->Cell(3.7 , 3.3,$lang['10521'], 0, 0 , 'C' , false);
			$pdf->SetXY(139.4,27);
			$pdf->Cell(3.7 , 3.3,$lang['10532'], 0, 0 , 'C' , false);
			$pdf->SetXY(143.1,27);
			$pdf->Cell(3.7 , 3.3,$lang['10543'], 0, 0 , 'C' , false);
			
			$pdf->SetXY(132,30.4);
			$pdf->Cell(3.7 , 3.3,$lang['10510'], 0, 0 , 'C' , false);
			$pdf->SetXY(135.7,30.4);
			$pdf->Cell(3.7 , 3.3,$lang['10522'], 0, 0 , 'C' , false);
			$pdf->SetXY(139.4,30.4);
			$pdf->Cell(3.7 , 3.3,$lang['10533'], 0, 0 , 'C' , false);
			$pdf->SetXY(143.1,30.4);
			$pdf->Cell(3.7 , 3.3,$lang['10544'], 0, 0 , 'C' , false);
			
			$pdf->SetXY(132,33.7);
			$pdf->Cell(3.7 , 3.3,$lang['10511'], 0, 0 , 'C' , false);
			$pdf->SetXY(135.7,33.7);
			$pdf->Cell(3.7 , 3.3,$lang['10523'], 0, 0 , 'C' , false);
			$pdf->SetXY(139.4,33.7);
			$pdf->Cell(3.7 , 3.3,$lang['10534'], 0, 0 , 'C' , false);
			$pdf->SetXY(143.1,33.7);
			$pdf->Cell(3.7 , 3.3,$lang['10545'], 0, 0 , 'C' , false);
			
			$pdf->SetXY(132,37.1);
			$pdf->Cell(3.7 , 3.3,$lang['10512'], 0, 0 , 'C' , false);
			$pdf->SetXY(135.7,37.1);
			$pdf->Cell(3.7 , 3.3,$lang['10524'], 0, 0 , 'C' , false);
			$pdf->SetXY(139.4,37.1);
			$pdf->Cell(3.7 , 3.3,$lang['10535'], 0, 0 , 'C' , false);
			$pdf->SetXY(143.1,37.1);
			$pdf->Cell(3.7 , 3.3,$lang['10546'], 0, 0 , 'C' , false);
			
			$pdf->SetXY(132,40.3);
			$pdf->Cell(3.7 , 3.3,$lang['10513'], 0, 0 , 'C' , false);
			$pdf->SetXY(135.7,40.3);
			$pdf->Cell(3.7 , 3.3,$lang['10525'], 0, 0 , 'C' , false);
			$pdf->SetXY(139.4,40.3);
			$pdf->Cell(3.7 , 3.3,$lang['10536'], 0, 0 , 'C' , false);
			$pdf->SetXY(143.1,40.3);
			$pdf->Cell(3.7 , 3.3,$lang['10547'], 0, 0 , 'C' , false);
			
            $pdf->SetXY(132,43.5);
			$pdf->Cell(3.7 , 3.3,$lang['10514'], 0, 0 , 'C' , false);
			$pdf->SetXY(135.7,43.5);
			$pdf->Cell(3.7 , 3.3,$lang['10526'], 0, 0 , 'C' , false);
			$pdf->SetXY(139.4,43.5);
			$pdf->Cell(3.7 , 3.3,$lang['10537'], 0, 0 , 'C' , false);
			$pdf->SetXY(143.1,43.5);
			$pdf->Cell(3.7 , 3.3,$lang['10548'], 0, 0 , 'C' , false);
			
			$pdf->SetXY(132,46.9);
			$pdf->Cell(3.7 , 3.3,$lang['10515'], 0, 0 , 'C' , false);
			$pdf->SetXY(135.7,46.9);
			$pdf->Cell(3.7 , 3.3,$lang['10527'], 0, 0 , 'C' , false);
			$pdf->SetXY(139.4,46.9);
			$pdf->Cell(3.7 , 3.3,$lang['10538'], 0, 0 , 'C' , false);
			$pdf->SetXY(143.1,46.9);
			$pdf->Cell(3.7 , 3.3,$lang['10549'], 0, 0 , 'C' , false);
			
			$pdf->SetXY(132,50.1);
			$pdf->Cell(3.7 , 3.3,$lang['10516'], 0, 0 , 'C' , false);
			$pdf->SetXY(135.7,50.1);
			$pdf->Cell(3.7 , 3.3,$lang['10528'], 0, 0 , 'C' , false);
			$pdf->SetXY(139.4,50.1);
			$pdf->Cell(3.7 , 3.3,$lang['10539'], 0, 0 , 'C' , false);
			$pdf->SetXY(143.1,50.1);
			$pdf->Cell(3.7 , 3.3,$lang['10550'], 0, 0 , 'C' , false);
			
			$pdf->SetXY(132,53.4);
			$pdf->Cell(3.7 , 3.3,$lang['10518'], 0, 0 , 'C' , false);
			$pdf->SetXY(135.7,53.4);
			$pdf->Cell(3.7 , 3.3,$lang['10529'], 0, 0 , 'C' , false);
			$pdf->SetXY(139.4,53.4);
			$pdf->Cell(3.7 , 3.3,$lang['10540'], 0, 0 , 'C' , false);
			$pdf->SetXY(143.1,53.4);
			$pdf->Cell(3.7 , 3.3,$lang['10551'], 0, 0 , 'C' , false);
			
	    	$pdf->SetXY(132,56.6);
			$pdf->Cell(3.7 , 3.2,$lang['10519'], 0, 0 , 'C' , false);
			$pdf->SetXY(135.7,56.6);
			$pdf->Cell(3.7 , 3.2,$lang['10530'], 0, 0 , 'C' , false);
			$pdf->SetXY(139.4,56.6);
			$pdf->Cell(3.7 , 3.2,$lang['10541'], 0, 0 , 'C' , false);
			$pdf->SetXY(143.1,56.6);
			$pdf->Cell(3.7 , 3.2,$lang['10552'], 0, 0 , 'C' , false);
			
			$pdf->SetXY(132,59.7);
			$pdf->Cell(3.8 , 3.2,$lang['10520'], 0, 0 , 'C' , false);
			$pdf->SetXY(135.7,59.7);
			$pdf->Cell(3.8 , 3.2,$lang['10531'], 0, 0 , 'C' , false);
			$pdf->SetXY(139.4,59.7);
			$pdf->Cell(3.8 , 3.2,$lang['10542'], 0, 0 , 'C' , false);
			$pdf->SetXY(143.1,59.7);
			$pdf->Cell(3.8 , 3.2,$lang['10553'], 0, 0 , 'C' , false);
...
/*Cabecera acomodoo en cancha del equipo Local 2do Set EMA 09.11.2022*/
 /*1ra. Fila Equipo Local 2do. Set*/
	...
	/* Puntos Equipo Visitante 2do. set visitante*/
		  	...
		  	$pdf->SetXY(258.5,27);
			$pdf->Cell(14.5 ,36, $lang['10137'], 1, 1 , 'C' , false);
	    ...
	    $pdf->SetXY(258.5,30.4);
			...
			$pdf->Cell(3.7 , 3.2,$lang['10553'], 0, 0 , 'C' , false);
	...
	/*Empieza arreglo de jugadores en cancha */
	  /*1ra fila 3er. 1set*/
		...
		$pdf->SetFont('Times' , 'B' , 5);
			...
			$pdf->SetFont('Times' , 'B' , 7);
			$pdf->SetXY($x+16,$y+79);
			$pdf->Cell(4 , 40, $lang['10507'], 1, 1 , 'C' , false);
			$pdf->SetXY($x+20,$y+79);
			$pdf->Cell(8, 5, $lang['10501'], 1, 1 , 'C' , false);
			$pdf->SetXY($x+28,$y+79);
			$pdf->Cell(8, 5, $lang['10502'], 1, 0, 'C' , false);
  ...
  $pdf->SetFont('Times' , 'B' , 5);
	...
	/* 8a. Fila Equipo Visitante 1er. set */
			...
			*/
			...
			$pdf->SetFont('Times' , '' , 6);
            $pdf->SetXY(132,78);
			$pdf->Cell(3.7 , 3.3,$lang['10509'], 0, 0 , 'C' , false);
			$pdf->SetXY(135.7,78);
			$pdf->Cell(3.7 , 3.3,$lang['10519'], 0, 0 , 'C' , false);
			$pdf->SetXY(139.4,78);
			$pdf->Cell(3.7 , 3.3,$lang['10528'], 0, 0 , 'C' , false);
			$pdf->SetXY(143.10,78);
			$pdf->Cell(3.7 , 3.3,$lang['10537'], 0, 0 , 'C' , false);
			...
			$pdf->Cell(3.7 , 3.3,$lang['10520'], 0, 0 , 'C' , false);
			...
			$pdf->Cell(3.7 , 3.3,$lang['10530'], 0, 0 , 'C' , false);
			...
			$pdf->Cell(3.7 , 3.3,$lang['10522'], 0, 0 , 'C' , false);
			$pdf->SetXY(139.4,88);
			$pdf->Cell(3.7 , 3.3,$lang['10531'], 0, 0 , 'C' , false);
			$pdf->SetXY(143.10,88);
			$pdf->Cell(3.7 , 3.3,$lang['10540'], 0, 0 , 'C' , false);
			...
			$pdf->Cell(3.7 , 3.3,$lang['10541'], 0, 0 , 'C' , false);
			...
			$pdf->Cell(3.7 , 3.3,$lang['10542'], 0, 0 , 'C' , false);
			...
			$pdf->Cell(3.7 , 3.3,$lang['10544'], 0, 0 , 'C' , false);
				...
				$pdf->SetXY(132,104.3);
			$pdf->Cell(3.7 , 3.5,$lang['10518'], 0, 0 , 'C' , false);
			$pdf->SetXY(135.7,104.3);
			$pdf->Cell(3.7 , 3.5,$lang['10527'], 0, 0 , 'C' , false);
			$pdf->SetXY(139.4,104.3);
			$pdf->Cell(3.7 , 3.5,$lang['10536'], 0, 0 , 'C' , false);
			$pdf->SetXY(143.10,104.3);
			$pdf->Cell(3.7 , 3.5,$lang['10545'], 0, 0 , 'C' , false);
		...
		/*	$pdf->SetXY(132,107.4);
			...
			$pdf->SetXY(132,108);
			$pdf->Cell(15 ,4.9, $lang['10137'], 1, 1 , 'C' , false);
			$pdf->SetXY(132,112.8);
			$pdf->Cell(15 ,5.2, $lang['10137'], 1, 1 , 'C' , false);
	...
	/*9a. Fila de Equipo Visitant 3er.set*/
	 /*     $pdf->SetFont('Times' , 'B' , 5);
		...
		$pdf->SetXY(196,81.3);
			$pdf->Cell(3.7 , 3.3,$lang['10510'], 0, 0 , 'C' , false);
			$pdf->SetXY(199.7,81.3);
			$pdf->Cell(3.7 , 3.3,$lang['10520'], 0, 0 , 'C' , false);
			$pdf->SetXY(203.4,81.3);
			$pdf->Cell(3.7 , 3.3,$lang['10529'], 0, 0 , 'C' , false);
			$pdf->SetXY(207.10,81.3);
			$pdf->Cell(3.7 , 3.3,$lang['10538'], 0, 0 , 'C' , false);
			
			$pdf->SetXY(196,84.6);
			$pdf->Cell(3.7 , 3.3,$lang['10511'], 0, 0 , 'C' , false);
			$pdf->SetXY(199.7,84.6);
			$pdf->Cell(3.7 , 3.3,$lang['10521'], 0, 0 , 'C' , false);
			$pdf->SetXY(203.4,84.6);
			$pdf->Cell(3.7 , 3.3,$lang['10530'], 0, 0 , 'C' , false);
			$pdf->SetXY(207.10,84.6);
			$pdf->Cell(3.7 , 3.3,$lang['10539'], 0, 0 , 'C' , false);
			...
			$pdf->SetXY(196,91.2);
			$pdf->Cell(3.7 , 3.3,$lang['10513'], 0, 0 , 'C' , false);
			$pdf->SetXY(199.7,91.2);
			$pdf->Cell(3.7 , 3.3,$lang['10523'], 0, 0 , 'C' , false);
			$pdf->SetXY(203.4,91.2);
			$pdf->Cell(3.7 , 3.3,$lang['10532'], 0, 0 , 'C' , false);
			$pdf->SetXY(207.10,91.2);
			$pdf->Cell(3.7 , 3.3,$lang['10541'], 0, 0 , 'C' , false);
			
			$pdf->SetXY(196,94.5);
			$pdf->Cell(3.7 , 3.3,$lang['10514'], 0, 0 , 'C' , false);
			$pdf->SetXY(199.7,94.5);
			$pdf->Cell(3.7 , 3.3,$lang['10524'], 0, 0 , 'C' , false);
			$pdf->SetXY(203.4,94.5);
			$pdf->Cell(3.7 , 3.3,$lang['10533'], 0, 0 , 'C' , false);
			$pdf->SetXY(207.10,94.5);
			$pdf->Cell(3.7 , 3.3,$lang['10542'], 0, 0 , 'C' , false);
			
			$pdf->SetXY(196,97.8);
			$pdf->Cell(3.7 , 3.3,$lang['10515'], 0, 0 , 'C' , false);
			$pdf->SetXY(199.7,97.8);
			$pdf->Cell(3.7 , 3.3,$lang['10525'], 0, 0 , 'C' , false);
			$pdf->SetXY(203.4,97.8);
			$pdf->Cell(3.7 , 3.3,$lang['10534'], 0, 0 , 'C' , false);
			$pdf->SetXY(207.10,97.8);
			$pdf->Cell(3.7 , 3.3,$lang['10543'], 0, 0 , 'C' , false);
			
			$pdf->SetXY(196,101.1);
			$pdf->Cell(3.7 , 3.3,$lang['10516'], 0, 0 , 'C' , false);
			$pdf->SetXY(199.7,101.1);
			$pdf->Cell(3.7 , 3.3,$lang['10526'], 0, 0 , 'C' , false);
			$pdf->SetXY(203.4,101.1);
			$pdf->Cell(3.7 , 3.3,$lang['10535'], 0, 0 , 'C' , false);
			$pdf->SetXY(207.10,101.1);
			$pdf->Cell(3.7 , 3.3,$lang['10544'], 0, 0 , 'C' , false);
			
				$pdf->SetXY(196,104.3);
			$pdf->Cell(3.7 , 3.5,$lang['10518'], 0, 0 , 'C' , false);
			$pdf->SetXY(199.7,104.3);
			$pdf->Cell(3.7 , 3.5,$lang['10527'], 0, 0 , 'C' , false);
			$pdf->SetXY(203.4,104.3);
			$pdf->Cell(3.7 , 3.5,$lang['10536'], 0, 0 , 'C' , false);
			$pdf->SetXY(207.10,104.3);
			$pdf->Cell(3.7 , 3.5,$lang['10545'], 0, 0 , 'C' , false);
			
			$pdf->SetXY($x+196,$y+109);
			$pdf->Cell(15, 5, $lang['10137'], 1, 1, 'C' , false);
			$pdf->SetXY($x+196,$y+114);
			$pdf->Cell(15, 5, $lang['10137'], 1, 0, 'C' , false);
		
		/*Linea que indica el Set*/	
		//	 	$pdf->SetXY($x+211,$y+73);
		//	$pdf->Cell(12 , 46, '', 1, 1 , 'C' , false);
	...
	/*Empieza apartado de Sanciones*/
		...
		$pdf->SetFont('Times' , 'B' , 7);
		    $pdf->SetXY(5,118);
		    $pdf->Cell(15 , 6, $lang['10556'], 1, 1 , 'L' , false);

            $pdf->SetFont('Times' , 'B' , 6);
		    $pdf->SetXY(20,117);
		    $pdf->Cell(20 , 6, $lang['10559'], 0, 0 , 'L' , false);
		    $pdf->SetXY(20,118);
		    $pdf->Cell(24 , 6, '', 1, 1 , 'C' , false);
		    $pdf->SetXY(20,119.5);
		    $pdf->Cell(24 , 6, $lang['10559-1'], 0, 0 , 'L' , false);
		   ...
		   $pdf->SetXY($x+5,$y+125);
			$pdf->Cell(3.75, 5, $lang['10557'], 1, 0, 'C' , false);
			$pdf->SetXY($x+8.75,$y+125);
			$pdf->Cell(3.75, 5, $lang['10558'], 1, 0, 'C' , false);
			$pdf->SetXY($x+12.5,$y+125);
			$pdf->Cell(3.75, 5, $lang['10583'], 1, 0, 'C' , false);
			$pdf->SetXY($x+16.2,$y+125);
			$pdf->Cell(3.75, 5, $lang['10584'], 1, 0, 'C' , false);
            
            /*Solicitud Improcedente*/
            $pdf->SetXY($x+19.9,$y+125);
			$pdf->Cell(8, 5, $lang['10569'], 1, 0, 'C' , false);
            $pdf->SetXY($x+27.9,$y+125);
			$pdf->Cell(8, 5, $lang['10507'], 1, 0, 'C' , false);
			$pdf->SetXY($x+35.9,$y+125);
			$pdf->Cell(8, 5, $lang['10585'], 1, 0, 'C' , false);
			
			/*OBSERVACIONES*/
			$pdf->SetXY(43.9,118);
		    $pdf->Cell(107 , 6, $lang['10560'], 1, 1 , 'C' , false);
		    
			$pdf->SetXY($x+43.9,$y+125);
			$pdf->Cell(107, 5, $lang['10136'], 1, 0, 'C' , false);
			
			/*RESULTADOS*/
				$pdf->SetXY(151,118);
		    $pdf->Cell(60 , 6, $lang['10561'], 1, 1 , 'C' , false);
		
         /*2da. Fila Amonestaciones*/
		   
		   $pdf->SetXY($x+5,$y+130);
			$pdf->Cell(3.75, 5, $lang['10136'], 1, 0, 'C' , false);
			$pdf->SetXY($x+8.75,$y+130);
			$pdf->Cell(3.75, 5, $lang['10136'], 1, 0, 'C' , false);
			$pdf->SetXY($x+12.5,$y+130);
			$pdf->Cell(3.75, 5, $lang['10136'], 1, 0, 'C' , false);
			$pdf->SetXY($x+16.2,$y+130);
			$pdf->Cell(3.75, 5, $lang['10136'], 1, 0, 'C' , false);
			
			$pdf->SetXY($x+19.9,$y+130);
			$pdf->Cell(8, 5, $lang['10136'], 1, 0, 'C' , false);
            $pdf->SetXY($x+27.9,$y+130);
			$pdf->Cell(8, 5, $lang['10136'], 1, 0, 'C' , false);
			$pdf->SetXY($x+35.9,$y+130);
			$pdf->Cell(8, 5, $lang['10136'], 1, 0, 'C' , false);
			
				/*OBSERVACIONES*/
		
			$pdf->SetXY($x+43.9,$y+130);
			$pdf->Cell(107, 5, $lang['10136'], 1, 0, 'C' , false);
			
		      /*RESULTADOS*/
			$pdf->SetXY(151,124);
		    $pdf->Cell(60 , 10, $lang['10136'], 1, 1 , 'C' , false);
		    
		    /*A*/
		    $pdf->SetFont('Times' , 'B' , 9);
			$pdf->SetXY(151,127);
		    $pdf->Cell(30 , 10, $lang['10587'], 0, 0 , 'R' , false);
		     
			$pdf->SetXY(151,124);
		    $pdf->Cell(30 , 10, $lang['10136'], 1, 0 , 'R' , false);
		    
		    /*B*/
		    $pdf->SetXY(181,124);
		    $pdf->Cell(30 , 10, $lang['10136'], 1, 0 , 'L' , false);
		    
		    $pdf->SetXY(181,127);
		    $pdf->Cell(30 , 10, $lang['10588'], 0, 0 , 'L' , false);
	    	...
	    	//$pdf->SetXY(215,77);
	    	$pdf->SetXY(151,126);
	    	$pdf->MultiCell(28, 3, az_utf8_decode($row1["Local"]), 0 , 'C' , false);
	    	//$pdf->SetXY(243,77);
	    	$pdf->SetXY(183,126);
	    	$pdf->MultiCell(28, 3, az_utf8_decode($row1["Visitante"]), 0 , 'C' , false);
		 ...
		 /*3ra. Fila Amonestaciones*/
		   ...
		   $pdf->SetXY($x+5,$y+135);
			$pdf->Cell(3.75, 5, $lang['10136'], 1, 0, 'C' , false);
			$pdf->SetXY($x+8.75,$y+135);
			$pdf->Cell(3.75, 5, $lang['10136'], 1, 0, 'C' , false);
			$pdf->SetXY($x+12.5,$y+135);
			$pdf->Cell(3.75, 5, $lang['10136'], 1, 0, 'C' , false);
			$pdf->SetXY($x+16.2,$y+135);
			$pdf->Cell(3.75, 5, $lang['10136'], 1, 0, 'C' , false);
			
		    $pdf->SetXY($x+19.9,$y+135);
			$pdf->Cell(8, 5, $lang['10136'], 1, 0, 'C' , false);
            $pdf->SetXY($x+27.9,$y+135);
			$pdf->Cell(8, 5, $lang['10136'], 1, 0, 'C' , false);
			$pdf->SetXY($x+35.9,$y+135);
			$pdf->Cell(8, 5, $lang['10136'], 1, 0, 'C' , false);
			
			/*OBSERVACIONES*/
		
			$pdf->SetXY($x+43.9,$y+135);
			$pdf->Cell(107, 5, $lang['10136'], 1, 0, 'C' , false);
			
			/*RESULTADOS*/
			$pdf->SetXY(151,134);
		    $pdf->Cell(60 , 5, $lang['10136'], 1, 1 , 'C' , false);
		    ...
		    $pdf->Cell(8 , 5, $lang['10592'], 1, 1 , 'C' , false);
		     ...
		     /*SET*/
		    $pdf->SetXY(173,134);
		    $pdf->Cell(18 , 5, $lang['10507'], 1, 1 , 'C' , false);
            ...
            /*G*/
		    $pdf->SetXY(199,134);
		    $pdf->Cell(4 , 5, $lang['10591'], 1, 1 , 'C' , false);
      ...
      /*4a. Fila Amonestaciones*/
		   ...
		   $pdf->SetXY($x+5,$y+140);
			$pdf->Cell(3.75, 5, $lang['10136'], 1, 0, 'C' , false);
			$pdf->SetXY($x+8.75,$y+140);
			$pdf->Cell(3.75, 5, $lang['10136'], 1, 0, 'C' , false);
			$pdf->SetXY($x+12.5,$y+140);
			$pdf->Cell(3.75, 5, $lang['10136'], 1, 0, 'C' , false);
			$pdf->SetXY($x+16.2,$y+140);
			$pdf->Cell(3.75, 5, $lang['10136'], 1, 0, 'C' , false);	

	    $pdf->SetXY($x+19.9,$y+140);
			$pdf->Cell(8, 5, $lang['10136'], 1, 0, 'C' , false);
            $pdf->SetXY($x+27.9,$y+140);
			$pdf->Cell(8, 5, $lang['10136'], 1, 0, 'C' , false);
			$pdf->SetXY($x+35.9,$y+140);
			$pdf->Cell(8, 5, $lang['10136'], 1, 0, 'C' , false);

	     /*OBSERVACIONES*/
		
			$pdf->SetXY($x+43.9,$y+140);
			$pdf->Cell(107, 5, $lang['10136'], 1, 0, 'C' , false);
		...
		/*RESULTADOS*/
		    ...
		    $pdf->SetFont('Times' , 'B' , 9);
			$pdf->SetXY(151,139);
		    $pdf->Cell(4 , 10, $lang['10136'], 1, 1 , 'C' , false);
		    ...
		    /*G*/
		    $pdf->SetXY(159,139);
		    $pdf->Cell(6 , 10, $lang['10136'], 1, 1 , 'C' , false);
		    
		     /*P*/
		    $pdf->SetXY(165,139);
		    $pdf->Cell(8 , 10, $lang['10136'], 1, 1 , 'C' , false);
		    
		     /*SET*/
		     
		    $pdf->SetXY(173,139);
		    $pdf->Cell(18 , 10, $lang['10509'] .'  ' . $lang['10593'], 1, 1 , 'C' , false);
	 ...
	 /*5a. Fila Amonestaciones*/
		   ...
		   $pdf->SetXY($x+5,$y+145);
			$pdf->Cell(3.75, 5, $lang['10136'], 1, 0, 'C' , false);
			$pdf->SetXY($x+8.75,$y+145);
			$pdf->Cell(3.75, 5, $lang['10136'], 1, 0, 'C' , false);
			$pdf->SetXY($x+12.5,$y+145);
			$pdf->Cell(3.75, 5, $lang['10136'], 1, 0, 'C' , false);
			$pdf->SetXY($x+16.2,$y+145);
			$pdf->Cell(3.75, 5, $lang['10136'], 1, 0, 'C' , false);
			
			$pdf->SetXY($x+19.9,$y+145);
			$pdf->Cell(8, 5, $lang['10136'], 1, 0, 'C' , false);
            $pdf->SetXY($x+27.9,$y+145);
			$pdf->Cell(8, 5, $lang['10136'], 1, 0, 'C' , false);
			$pdf->SetXY($x+35.9,$y+145);
			$pdf->Cell(8, 5, $lang['10136'], 1, 0, 'C' , false);

          /*OBSERVACIONES*/
		
			$pdf->SetXY($x+43.9,$y+145);
			$pdf->Cell(107, 5, $lang['10136'], 1, 0, 'C' , false);
		...
		/*RESULTADOS*/
		    ...
		    $pdf->SetXY(173,149);
		    $pdf->Cell(18 , 10, $lang['10510'] .'  ' . $lang['10593'], 1, 1 , 'C' , false);
	 ...
	 /*6a. Fila Amonestaciones*/
		   ...
		   $pdf->SetXY($x+5,$y+150);
			$pdf->Cell(3.75, 5, $lang['10136'], 1, 0, 'C' , false);
			$pdf->SetXY($x+8.75,$y+150);
			$pdf->Cell(3.75, 5, $lang['10136'], 1, 0, 'C' , false);
			$pdf->SetXY($x+12.5,$y+150);
			$pdf->Cell(3.75, 5, $lang['10136'], 1, 0, 'C' , false);
			$pdf->SetXY($x+16.2,$y+150);
			$pdf->Cell(3.75, 5, $lang['10136'], 1, 0, 'C' , false);
			
			$pdf->SetXY($x+19.9,$y+150);
			$pdf->Cell(8, 5, $lang['10136'], 1, 0, 'C' , false);
            $pdf->SetXY($x+27.9,$y+150);
			$pdf->Cell(8, 5, $lang['10136'], 1, 0, 'C' , false);
			$pdf->SetXY($x+35.9,$y+150);
			$pdf->Cell(8, 5, $lang['10136'], 1, 0, 'C' , false);
           ...
           /*OBSERVACIONES*/
			...
			/*APROBACION*/
		   /* $pdf->SetFont('Times' , 'B' , 9);
			$pdf->SetXY($x+44.8,$y+150);
			$pdf->Cell(110.5, 5, $lang['10572'], 1, 0, 'C' , false);*/
			$pdf->SetFont('Times' , 'B' , 9);
			$pdf->SetXY($x+43.9,$y+150);
		    ...
		    $pdf->SetXY(173,159);
		    $pdf->Cell(18 , 10, $lang['10511'] .'  ' . $lang['10593'], 1, 1 , 'C' , false);
	 ...
	 /*7a. Fila Amonestaciones*/
		   ...
		   $pdf->SetXY($x+5,$y+155);
			$pdf->Cell(3.75, 5, $lang['10136'], 1, 0, 'C' , false);
			$pdf->SetXY($x+8.75,$y+155);
			$pdf->Cell(3.75, 5, $lang['10136'], 1, 0, 'C' , false);
			$pdf->SetXY($x+12.5,$y+155);
			$pdf->Cell(3.75, 5, $lang['10136'], 1, 0, 'C' , false);
			$pdf->SetXY($x+16.2,$y+155);
			$pdf->Cell(3.75, 5, $lang['10136'], 1, 0, 'C' , false);
			
		    $pdf->SetXY($x+19.9,$y+155);
			$pdf->Cell(8, 5, $lang['10136'], 1, 0, 'C' , false);
            $pdf->SetXY($x+27.9,$y+155);
			$pdf->Cell(8, 5, $lang['10136'], 1, 0, 'C' , false);
			$pdf->SetXY($x+35.9,$y+155);
			$pdf->Cell(8, 5, $lang['10136'], 1, 0, 'C' , false);
		 ...
		 /*APROBACION*/
		   /* $pdf->SetFont('Times' , 'B' , 9);
			$pdf->SetXY($x+43.9,$y+155);
			$pdf->Cell(112, 5, $lang['10573'] , 1, 0, 'L' , false);*/
			...
			$pdf->Cell(27, 5, $lang['9994'] , 1, 0, 'C' , false);
		    ...
		    $pdf->Cell(8 , 10, $lang['10136'], 1, 1 , 'C' , false);
		     ...
		     /*SET*/
		      $pdf->SetFont('Times' , 'B' , 6);
		      $pdf->SetXY(173,169);
		    $pdf->Cell(18 , 3, $lang['10594'], 0, 0 , 'C' , false);
		     $pdf->SetFont('Times' , 'B' , 9);
		    $pdf->SetXY(173,169);
		    $pdf->Cell(18 , 10, $lang['10593'], 1, 1 , 'C' , false);
	 ...
	 /*8a. Fila Amonestaciones*/
		   ...
		   $pdf->SetXY($x+5,$y+160);
			$pdf->Cell(3.75, 5, $lang['10136'], 1, 0, 'C' , false);
			$pdf->SetXY($x+8.75,$y+160);
			$pdf->Cell(3.75, 5, $lang['10136'], 1, 0, 'C' , false);
			$pdf->SetXY($x+12.5,$y+160);
			$pdf->Cell(3.75, 5, $lang['10136'], 1, 0, 'C' , false);
			$pdf->SetXY($x+16.2,$y+160);
			$pdf->Cell(3.75, 5, $lang['10136'], 1, 0, 'C' , false);
	
		    $pdf->SetXY($x+19.9,$y+160);
			$pdf->Cell(8, 5, $lang['10136'], 1, 0, 'C' , false);
            $pdf->SetXY($x+27.9,$y+160);
			$pdf->Cell(8, 5, $lang['10136'], 1, 0, 'C' , false);
			$pdf->SetXY($x+35.9,$y+160);
			$pdf->Cell(8, 5, $lang['10136'], 1, 0, 'C' , false);
		    ...
		    $pdf->SetFont('Times' , 'B' , 9);
			$pdf->SetXY(151,179);
		    $pdf->Cell(22 , 10, $lang['10136'], 1, 1 , 'C' , false);
		    
		        $pdf->SetFont('Times' , 'B' , 6);
		      $pdf->SetXY(151,179);
		    $pdf->Cell(22 , 3, $lang['10595'], 0, 0 , 'C' , false);
		   
		    $pdf->SetFont('Times' , 'B' , 7);
		     $pdf->SetXY(151,179);
		    $pdf->Cell(22 , 14, $lang['10598'], 0, 0 , 'C' , false);
		    
		
		     /*SET*/
		      $pdf->SetFont('Times' , 'B' , 6);
		      $pdf->SetXY(173,179);
		    $pdf->Cell(18 , 3, $lang['10596'], 0, 0 , 'C' , false);
		   
		    $pdf->SetFont('Times' , 'B' , 7);
		     $pdf->SetXY(173,179);
		    $pdf->Cell(18 , 14, $lang['10598'], 0, 0 , 'C' , false);
		    
		    $pdf->SetXY(173,179);
		    $pdf->Cell(18 , 10, $lang['10136'], 1, 1 , 'C' , false);
		    
		     /*P*/
		    $pdf->SetXY(191,179);
		    $pdf->Cell(20 , 10, $lang['10136'], 1, 1 , 'C' , false);
             
            $pdf->SetFont('Times' , 'B' , 6);
		    $pdf->SetXY(191,179);
		    $pdf->Cell(20 , 3, $lang['10597'], 0, 0 , 'C' , false);
		   
		    $pdf->SetFont('Times' , 'B' , 7);
		     $pdf->SetXY(191,179);
		    $pdf->Cell(20 , 14, $lang['10598'], 0, 0 , 'C' , false);
	 ...
	 /*9a. Fila Amonestaciones*/
		   ...
		   $pdf->SetXY($x+5,$y+165);
			$pdf->Cell(3.75, 5, $lang['10136'], 1, 0, 'C' , false);
			$pdf->SetXY($x+8.75,$y+165);
			$pdf->Cell(3.75, 5, $lang['10136'], 1, 0, 'C' , false);
			$pdf->SetXY($x+12.5,$y+165);
			$pdf->Cell(3.75, 5, $lang['10136'], 1, 0, 'C' , false);
			$pdf->SetXY($x+16.2,$y+165);
			$pdf->Cell(3.75, 5, $lang['10136'], 1, 0, 'C' , false);
			
		    $pdf->SetXY($x+19.9,$y+165);
			$pdf->Cell(8, 5, $lang['10136'], 1, 0, 'C' , false);
            $pdf->SetXY($x+27.9,$y+165);
			$pdf->Cell(8, 5, $lang['10136'], 1, 0, 'C' , false);
			$pdf->SetXY($x+35.9,$y+165);
			$pdf->Cell(8, 5, $lang['10136'], 1, 0, 'C' , false);
	...
	/*RESULTADOS*/
			$pdf->SetXY(151,189);
		    $pdf->Cell(60 , 5, $lang['10599'], 0, 0 , 'L' , false);
		    $pdf->SetXY(151,189);
		    $pdf->Cell(60 , 10, $lang['105136'], 1, 1 , 'L' , false);
	...
	/*10a. Fila Amonestaciones*/
		   ...
		   $pdf->SetXY($x+5,$y+170);
			$pdf->Cell(3.75, 5, $lang['10136'], 1, 0, 'C' , false);
			$pdf->SetXY($x+8.75,$y+170);
			$pdf->Cell(3.75, 5, $lang['10136'], 1, 0, 'C' , false);
			$pdf->SetXY($x+12.5,$y+170);
			$pdf->Cell(3.75, 5, $lang['10136'], 1, 0, 'C' , false);
			$pdf->SetXY($x+16.2,$y+170);
			$pdf->Cell(3.75, 5, $lang['10136'], 1, 0, 'C' , false);
			
			 $pdf->SetXY($x+19.9,$y+170);
			$pdf->Cell(8, 5, $lang['10136'], 1, 0, 'C' , false);
            $pdf->SetXY($x+27.9,$y+170);
			$pdf->Cell(8, 5, $lang['10136'], 1, 0, 'C' , false);
			$pdf->SetXY($x+35.9,$y+170);
			$pdf->Cell(8, 5, $lang['10136'], 1, 0, 'C' , false);
	...
	/*11a. Fila Amonestaciones*/
		   ...
		   $pdf->SetXY($x+5,$y+175);
			$pdf->Cell(3.75, 5, $lang['10136'], 1, 0, 'C' , false);
			$pdf->SetXY($x+8.75,$y+175);
			$pdf->Cell(3.75, 5, $lang['10136'], 1, 0, 'C' , false);
			$pdf->SetXY($x+12.5,$y+175);
			$pdf->Cell(3.75, 5, $lang['10136'], 1, 0, 'C' , false);
			$pdf->SetXY($x+16.2,$y+175);
			$pdf->Cell(3.75, 5, $lang['10136'], 1, 0, 'C' , false);
	        
	        $pdf->SetXY($x+19.9,$y+175);
			$pdf->Cell(8, 5, $lang['10136'], 1, 0, 'C' , false);
            $pdf->SetXY($x+27.9,$y+175);
			$pdf->Cell(8, 5, $lang['10136'], 1, 0, 'C' , false);
			$pdf->SetXY($x+35.9,$y+175);
			$pdf->Cell(8, 5, $lang['10136'], 1, 0, 'C' , false);
	...
	/*12a. Fila Amonestaciones*/
		   ...
		   $pdf->SetXY($x+5,$y+180);
			$pdf->Cell(3.75, 5, $lang['10136'], 1, 0, 'C' , false);
			$pdf->SetXY($x+8.75,$y+180);
			$pdf->Cell(3.75, 5, $lang['10136'], 1, 0, 'C' , false);
			$pdf->SetXY($x+12.5,$y+180);
			$pdf->Cell(3.75, 5, $lang['10136'], 1, 0, 'C' , false);
			$pdf->SetXY($x+16.2,$y+180);
			$pdf->Cell(3.75, 5, $lang['10136'], 1, 0, 'C' , false);
			
			 $pdf->SetXY($x+19.9,$y+180);
			$pdf->Cell(8, 5, $lang['10136'], 1, 0, 'C' , false);
            $pdf->SetXY($x+27.9,$y+180);
			$pdf->Cell(8, 5, $lang['10136'], 1, 0, 'C' , false);
			$pdf->SetXY($x+35.9,$y+180);
			$pdf->Cell(8, 5, $lang['10136'], 1, 0, 'C' , false);
			...
			$pdf->Cell(107, 5, $lang['10136'], 1, 0, 'C' , false);
		    	...
		    	$pdf->SetFont('Times' , 'B' , 9);	
			$pdf->SetXY($x+43.9,$y+180);
			$pdf->Cell(45, 5, $lang['10509'], 1, 0, 'R' , false);
			
			$pdf->SetFont('Times' , 'B' , 6);
			$pdf->SetXY($x+89,$y+180);
			$pdf->Cell(10, 5, $lang['10580'], 1, 0, 'C' , false);
		
		    $pdf->SetFont('Times' , 'B' , 9);
			$pdf->SetXY($x+99,$y+180);
			$pdf->Cell(3, 5, $lang['10510'], 0, 0, 'R' , false);

           /* $pdf->SetXY($x+5,$y+185);
			$pdf->Cell(40, 15, $lang['10136'], 1, 0, 'C' , false);
*/
			...
			$pdf->Cell(107, 5, $lang['10136'], 1, 0, 'C' , false);
				...
				$pdf->SetFont('Times' , 'B' , 9);
			$pdf->SetXY($x+43.9,$y+185);
			$pdf->Cell(45, 5, $lang['10511'], 1, 0, 'R' , false);
			
			$pdf->SetFont('Times' , 'B' , 6);
			$pdf->SetXY($x+89,$y+185);
			$pdf->Cell(10, 5, $lang['10581'], 1, 0, 'C' , false);
			
			$pdf->SetFont('Times' , 'B' , 9);
			$pdf->SetXY($x+99,$y+185);
			$pdf->Cell(3, 5, $lang['10512'], 0, 0, 'R' , false);
	
	        $pdf->SetXY($x+5,$y+185);
			$pdf->Cell(39, 15, $lang['10136'], 1, 0, 'C' , false);
			...
			$pdf->SetFont('Times' , 'B' , 8);
			$pdf->SetXY($x+89,$y+190);
			$pdf->Cell(10, 7, $lang['10582'], 0, 0, 'C' , false);
			
			$pdf->SetFont('Times' , 'B' , 9);
			$pdf->SetXY($x+43.9,$y+190);
			$pdf->Cell(43, 10, $lang['10587'], 1, 0, 'R' , false);
			
			$pdf->SetXY($x+105,$y+190);
			$pdf->Cell(3, 10, $lang['10588'], 0, 0, 'R' , false);
			
			$pdf->SetXY($x+87,$y+190);
			$pdf->Cell(.1, 10, $lang['10136'], 1, 0, 'C' , false);
			
			$pdf->SetXY($x+101,$y+190);
			$pdf->Cell(.1, 10, $lang['10136'], 1, 0, 'C' , false);
    ...
    /*Termina Amonestaciones*/		 
           ...
           /*Titul de firmas*/
		    ...
		    $pdf->SetFont('Times' , 'B' , 9);
		    $pdf->SetXY(211,179);
		    $pdf->Cell(62 , 5, $lang['9994'], 1, 0 , 'C' , false);
		   
    
    	   /*1ra. Firma Capitam*/
		    $pdf->SetFont('Times' , 'B' , 6);
		    $pdf->SetXY(211,184);
		    $pdf->Cell(30 , 8, $lang['10136'], 1, 1 , 'L' , false);
		    
		    $pdf->SetFont('Times' , 'B' , 6);
		    $pdf->SetXY(211,182);
		    $pdf->Cell(30 , 8 , $lang['10564'], 0, 0 , 'L' , false);
		
		  /*2da. Firma Capitam*/
		    $pdf->SetFont('Times' , 'B' , 6);
		     $pdf->SetXY(241,184);
		    $pdf->Cell(32 , 8, $lang['10136'], 1, 1 , 'L' , false);
		    
		   $pdf->SetFont('Times' , 'B' , 6);
		    $pdf->SetXY(241,182);
		    $pdf->Cell(32 , 8 , $lang['10564'], 0, 0 , 'L' , false);


          /* Entrenador */
		    $pdf->SetFont('Times' , 'B' , 6);
		     $pdf->SetXY(211,192);
		    $pdf->Cell(30 , 7, $lang['10136'], 1, 1 , 'L' , false);
		    
		    $pdf->SetFont('Times' , '' , 6);
		    $pdf->SetXY(211,190);
		    $pdf->Cell(30 , 7 , $lang['10565'], 0, 0 , 'L' , false);
		
		  /*2da. Firma Capitam*/
		    $pdf->SetFont('Times' , '' , 6);
		    $pdf->SetXY(241,192);
		    $pdf->Cell(32 , 7, $lang['10136'], 1, 1 , 'L' , false);
		    
		    $pdf->SetFont('Times' , '' , 6);
		    $pdf->SetXY(241,190);
		    $pdf->Cell(32 , 7 , $lang['10565'], 0, 0 , 'L' , false);
         
         /*Espacio en blanco ates de directivos */ 
            $pdf->SetFont('Times' , 'B' , 8);
		    $pdf->SetXY(211,144);
		    $pdf->Cell(62 , 10, $lang['10136'], 1, 1 , 'C' , false);
		    
        /*Directivos*/
 
		    $pdf->SetFont('Times' , 'B' , 9);
		    $pdf->SetXY(211,154);
		    $pdf->Cell(62 , 5, $lang['10563'], 1, 1 , 'C' , false);
		...
		/* LETRA E */    
		    $pdf->SetFont('Times' , '' , 9);
		    $pdf->SetXY(236,159);
		    $pdf->Cell(10 , 5 , $lang['10568'], 1, 1 , 'C' , false);
		    
		    $pdf->SetFont('Times' , 'B' , 8);
		    $pdf->SetXY(246,159);
		    $pdf->Cell(27 , 5, $lang['10136'], 1, 1 , 'C' , false);
	  ...
	  /* LETRA AE */    
		    ...
		    $pdf->SetFont('Times' , '' , 9);
		    $pdf->SetXY(236,164);
		    $pdf->Cell(10 , 5 , $lang['10569'], 1, 1 , 'C' , false);
   ...
   /* LETRA PF */    
		    ...
		    $pdf->SetFont('Times' , '' , 9);
		    $pdf->SetXY(236,169);
		    $pdf->Cell(10 , 5 , $lang['10570'], 1, 0 , 'C' , false);
		    
		      $pdf->SetFont('Times' , 'B' , 8);
		     $pdf->SetXY(246,169);
		    $pdf->Cell(27 , 5, $lang['10136'], 1, 0 , 'C' , false);
    ...
    /* LETRA M */    
		    ...
		    $pdf->SetFont('Times' , '' , 9);
		    $pdf->SetXY(236,174);
		    $pdf->Cell(10 , 5 , $lang['10571'], 1, 0 , 'C' , false);
		...
		/*	$pdf->SetXY($x+42,$y+49.5);
            ...
            $pdf->SetFont('Helvetica' , '' , 10);
            $pdf->SetTextColor(0, 0, 0);
	    	$pdf->Cell(62, 11, '' , 1, 1 , 'C' , false);
	    	$pdf->SetXY(213,77);
	    	$pdf->MultiCell(32, 3, az_utf8_decode($row1["Local"]), 0 , 'C' , false);
	    	$pdf->SetXY(243,77);
	    	$pdf->MultiCell(32, 3, az_utf8_decode($row1["Visitante"]), 0 , 'C' , false);
		    ...
		    while($countRow < 15) {
        			...
        			$pdf->Cell(4 , 4, $lang['10136'], 1, 1 , 'C' , 1);
        			...
        			//Apodo L
        			$pdf->SetFillColor(255, 255, 255);
        			$pdf->Cell(22, 4, az_utf8_decode(''), 1, 0, 'L' , false);
        			
        			$pdf->SetXY($x+242,$y+85);
        			$pdf->Cell(4, 4, $lang['10136'], 1, 0, 'L' , false);
        			
        			$pdf->SetXY($x+246,$y+85);
        			$pdf->Cell(5 , 4, '', 1, 1 , 'C' , 1);
        			
        			$pdf->SetXY($x+251,$y+85);
        			$pdf->Cell(22, 4, '', 1, 0, 'L' , false);
            ...
            if ($resultL && $resultL->num_rows > 0) {
                ...
                $pdf->SetXY($x+220,$y+85);
                $pdf->SetFillColor(255, 255, 255);
                $pdf->Cell(22, 4, az_utf8_decode('' . az_utf8_decode($rowL["Apodo"]) . ''), 0, 0, 'L' , false);
                //$pdf->Cell(72, 4, az_utf8_decode('' . az_utf8_decode($rowL["Nombre"]) . ' ' . az_utf8_decode($rowL["Apellido_P"]) . ' ' . az_utf8_decode($rowL["Apellido_M"]) . ''), 1, 0, 'L' , false);
                $y= $y+4;
                $tmpy = $tmpy + 4;
        ...
        if ($resultV && $resultV->num_rows > 0) {
            ...
            while($rowV = $resultV->fetch_assoc()) {
                ...
                $pdf->SetXY($x+220,$y+85);
                $pdf->SetFillColor(255, 255, 255);
                $pdf->Cell(22, 4, az_utf8_decode('' . az_utf8_decode($rowV["Apodo"]) . ''), 0, 0, 'L' , false);
                //$pdf->Cell(72, 4, az_utf8_decode('' . az_utf8_decode($rowL["Nombre"]) . ' ' . az_utf8_decode($rowL["Apellido_P"]) . ' ' . az_utf8_decode($rowL["Apellido_M"]) . ''), 1, 0, 'L' , false);
                $y= $y+4;
            }
        }
	...
	/*Se comenta esta parte porque no es necesario la 2da. hoja */
...
/*			$x = 0;
			...
			$pdf->SetXY($x+10,$y+20);
			$pdf->Cell(128 , 4, mb_strtoupper(az_utf8_decode('' . az_utf8_decode($row1["Local"]) . ' (' . $lang['998'] . ')')), 0, 1 , 'l' , false);
			$pdf->SetXY($x+10,$y+30);
			...
			$x = $x + 130;
			$pdf->SetXY($x+10,$y+20);
			$pdf->Cell(128 , 4, mb_strtoupper (az_utf8_decode('' . az_utf8_decode($row1["Visitante"]) . ' (' . $lang['999'] . ')')), 0, 1 , 'l' , false);
			$pdf->SetXY($x+10,$y+30);
			$pdf->Cell(128 , 4, $lang['9991'], 0, 1 , 'l' , false);
			$pdf->SetXY($x+10,$y+40);
			$pdf->Cell(128 , 7, '', 1, 1 , 'l' , false);
