-- Update TeamCreate / TeamUpdate to accept and persist Institucion_ID and team colors.
-- Run after tools/sql/add-equipos-institucion-id.sql
-- Re-run this file if the institution-only version was already installed.
