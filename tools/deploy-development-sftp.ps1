...
# Uses: git archive (excludes each site's imagenes/) -> pscp -> remote tar -xzf
...
Write-Host "git archive $ref -> $localTar (excluding site imagenes/ trees)"
...
Write-Host 'Extracting on server (symlinks preserved; imagenes/ omitted from archive)...'
