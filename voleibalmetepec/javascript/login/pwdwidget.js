...
function PasswordWidget(divid,pwdname, Show, Mask, Generate, weak, medium, good)
{
	this.maindivobj = document.getElementById(divid);
	this.pwdobjname = pwdname;

	this.MakePWDWidget=_MakePWDWidget;
	this.MakePWDWidget2=_MakePWDWidget2;
...
function _MakePWDWidget()
{
	...
	code += "<input type='password' autocomplete='new-password' class='form-control' placeholder='•••••••••••••' name='"+pwdname+"' id='"+this.pwdfieldid+"'>";

	this.pwdtxtfield=pwdname+"_text";

	this.pwdtxtfieldid = this.pwdtxtfield+"_id";

	code += "<input type='text' class='form-control' placeholder='•••••••••••••' name='"+this.pwdtxtfield+"' id='"+this.pwdtxtfieldid+"' style='display: none;'>";
...
function _MakePWDWidget2()
{
	...
	code += "<input type='password' name='"+pwdname+"' autocomplete='off' class='form-control' placeholder='•••••••••••••' id='"+this.pwdfieldid+"'>";

	this.pwdtxtfield=pwdname+"_text";

	this.pwdtxtfieldid = this.pwdtxtfield+"_id";

	code += "<input type='text' name='"+this.pwdtxtfield+"' autocomplete='off' class='form-control' placeholder='•••••••••••••' id='"+this.pwdtxtfieldid+"' style='display: none;'>";
