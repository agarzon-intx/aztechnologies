...
unset($__i, $__prev, $__base, $__inc, $__app_here);
	...
	$sessionstat = $fgmembersite->CheckLogin('AlertsManagement.php');
	...
	$htmlAlerts .= '<div id="alertsManagement" class="tabla active" style="display: block;padding-top: 10px;">
						...
						<!--<ul class="nav nav-pills nav-fill p-1" role="tablist" style="background: #cee6ff; flex-direction: unset !important;" id="config1">
							...
							<li class="nav-item" id="generalli">
								<a class="nav-link mb-0 px-0 py-1" data-bs-toggle="tab" style="cursor: pointer;" callval="#general" role="tab" aria-controls="generalli" aria-selected="false">
									<img src="./imagenes/stats.png?tmp=?tmp=' . $fecha->getTimestamp() . '" style="width: 20px; height: auto;" alt=""/>  ' . $lang['452'] . '
								</a>
							</li>
						</ul>-->
					</div>
	...
	/*-----------------------------------------------------------------------------------------------------------------------------
	-----------------------------------------------------------------------------------------------------------------------------*/
	$htmlAlerts .= '<div id="alertsManagementList" class="tabla active" style="display: block; height: auto;">';
	require 'AlertsManagementActiveList.php';
	$htmlAlerts .= '</div>';
	/*-----------------------------------------------------------------------------------------------------------------------------
	-----------------------------------------------------------------------------------------------------------------------------*/
	...
	/*-----------------------------------------------------------------------------------------------------------------------------
	-----------------------------------------------------------------------------------------------------------------------------*/
	$htmlAlerts .= '<div id="alertsManagementCreate" class="tabla" style="display: none; height: auto;">';
	$htmlAlerts .= '</div>';
	/*-----------------------------------------------------------------------------------------------------------------------------
	-----------------------------------------------------------------------------------------------------------------------------*/
	...
	/*-----------------------------------------------------------------------------------------------------------------------------
	-----------------------------------------------------------------------------------------------------------------------------*/
	$htmlAlerts .= '<div id="alertsManagementEdit" class="tabla" style="display: none; height: auto;">';
	$htmlAlerts .= '</div>';
	/*-----------------------------------------------------------------------------------------------------------------------------
	-----------------------------------------------------------------------------------------------------------------------------*/
	$htmlAlerts .= "</div> 
    ...
    $retunData = array('status' => '1', 'message' => 'Success.', 'dataAlert' => $htmlAlerts);
    $Config->Close();
