									...
									<div class="row">
										...
										<div class="col-6 col-sm-6 col-md-6 col-lg-6 col-xl-6">
											<div style="text-align:left; border: none; margin-top: 10px !important">
												<button style="margin-top: -5px; margin-bottom: 15px;" type="button" class="btn btn-primary" onclick="SaveGameDetailPlayerStatsS(' . $Season . ',' . $Week . ',' . $Game . ',' . $lequipoid . ',' . $vequipoid . ', $(\'#arbitroS\').val(), $(\'#comentarioS\').val(), $(\'#extralS\').val(), $(\'#extravS\').val());">' . $lang['0000'] . '</button>
											</div>
										</div>
									</div>
								</td>
