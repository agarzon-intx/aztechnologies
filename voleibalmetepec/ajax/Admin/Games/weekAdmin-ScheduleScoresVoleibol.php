            ...
            $sql2 = "select * from (
								select 0 as VisitanteS, 
										...
										case 
											when jugado = 0 then 
												concat('<option value=''0'' selected>" . $lang['660'] . "</option><option value=''1''>" . $lang['661'] . "</option><option value=''2''>" . $lang['662'] . "</option><option value=''10''>" . $lang['675'] . "</option>')
											when jugado = 1 then 
												concat('<option value=''0''>" . $lang['660'] . "</option><option value=''1'' selected>" . $lang['661'] . "</option><option value=''2''>" . $lang['662'] . "</option><option value=''10''>" . $lang['675'] . "</option>')
											when jugado = 2 then 
												concat('<option value=''0''>" . $lang['660'] . "</option><option value=''1''>" . $lang['661'] . "</option><option value=''2'' selected>" . $lang['662'] . "</option><option value=''10''>" . $lang['675'] . "</option>')
											when jugado = 10 then 
												concat('<option value=''0''>" . $lang['660'] . "</option><option value=''1''>" . $lang['661'] . "</option><option value=''2''>" . $lang['662'] . "</option><option value=''10'' selected>" . $lang['675'] . "</option>')
										end as jugado,
				...
				if ($result3->num_rows > 0) {
					...
					$htmlWeek .= '						</select>
								...
								</tr><script>loadVisitanteAgregar($(\'#localAgregar  option:selected\').val());</script>';
				}
