...
unset($__i, $__prev, $__base, $__inc, $__app_here);
	...
	$sessionstat = $fgmembersite->CheckLogin('gameManagementUpdateGamePlayerStatPlayed.php');
	...
	$sql = "CALL $schema.GameUpdateDetailPlayed('" . $_SESSION[$Config->getAlias() . 'username'] . "', $Player, $Team, $Game, $Week, $Season, $Played, @out);";
