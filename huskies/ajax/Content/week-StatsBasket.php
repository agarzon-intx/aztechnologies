            <?php
				$htmlWeek .= '<div class="container-fluid py-0" style="padding-left: 0px; padding-right: 0px; padding-top: 2px !important;">
                                ...
                                $htmlWeek .= '							<div class="d-none d-xs-none d-md-block d-lg-block d-xl-block">
													<img src="./imagenes/tabla.png" style="width: 20px; height: auto;" alt=""/>' . $lang['612'] . '
												</div>
												<div class="d-block d-xs-block d-md-none d-lg-none d-xl-none">
													<img src="./imagenes/tabla.png" style="width: 20px; height: auto;" alt=""/>
												</div>
											</a>
										</li>
                                ...
                                if($Config->getSport() == 2){
                                        $htmlWeek .= '                                          <div class="d-none d-xs-none d-md-block d-lg-block d-xl-block">
                                                                                                ...
                                                                                                <div class="d-block d-xs-block d-md-none d-lg-none d-xl-none">
                                                                                                        <img src="./imagenes/Pointb.png" style="width: 20px; height: auto;" alt=""/>
                                                                                                </div>';
                                ...
                                if($Config->getSport() == 2){
                                        $htmlWeek .= '                                          <div class="d-none d-xs-none d-md-block d-lg-block d-xl-block">
                                                                                                ...
                                                                                                <div class="d-block d-xs-block d-md-none d-lg-none d-xl-none">
                                                                                                        <img src="./imagenes/faltabasket.png" style="width: 20px; height: auto;" alt=""/>
                                                                                                </div>';
					...
					$htmlWeek .= '				<li class="nav-item" id="primeraExpulsados' . $row["Jornada"] . 'li">
											<a class="nav-link mb-0 px-0 py-1" data-bs-toggle="tab" style="cursor: pointer;" callval="#primeraExpulsados' . $row["Jornada"] . '" role="tab" aria-controls="primeraExpulsados' . $row["Jornada"] . 'li" aria-selected="false">
												<div class="d-none d-xs-none d-md-block d-lg-block d-xl-block">
													<img src="./imagenes/roja.png" style="width: 20px; height: auto;" alt=""/>' . $lang['615'] . '
												</div>
												<div class="d-block d-xs-block d-md-none d-lg-none d-xl-none">
													<img src="./imagenes/roja.png" style="width: 20px; height: auto;" alt=""/>
												</div>
											</a>
										</li>';
				}
				$htmlWeek .= '
								...
								$htmlWeek .= "</div><script>initNavs('statS');</script>";
							$htmlWeek .= '</div>';
