...
unset($__i, $__prev, $__base, $__inc, $__app_here);
	...
	$sessionstat = $fgmembersite->CheckLogin('TournamentManagement.php');
	...
	$htmlTournament .= '<div id="tournamentsManagement" class="tabla active" style="display: block;padding-top: 10px;">
	...
	/*-----------------------------------------------------------------------------------------------------------------------------
	-----------------------------------------------------------------------------------------------------------------------------*/
	$htmlTournament .= '<div id="tournamentsManagementList" class="tabla active" style="display: block; height: auto;">';
	require 'TournamentsManagementActiveList.php';	
	$htmlTournament .= '</div>';            
	/*-----------------------------------------------------------------------------------------------------------------------------
	-----------------------------------------------------------------------------------------------------------------------------*/
	...
	/*-----------------------------------------------------------------------------------------------------------------------------
	-----------------------------------------------------------------------------------------------------------------------------*/
	$htmlTournament .= '<div id="tournamentsManagementCreate" class="tabla" style="display: none; height: auto;">';
	$htmlTournament .= '</div>';            
	/*-----------------------------------------------------------------------------------------------------------------------------
	-----------------------------------------------------------------------------------------------------------------------------*/
	...
	/*-----------------------------------------------------------------------------------------------------------------------------
	-----------------------------------------------------------------------------------------------------------------------------*/
	$htmlTournament .= '<div id="tournamentsManagementEdit" class="tabla" style="display: none; height: auto;">';
	$htmlTournament .= '</div>';            
	/*-----------------------------------------------------------------------------------------------------------------------------
	-----------------------------------------------------------------------------------------------------------------------------*/
	$htmlTournament .= "</div> 
    ...
    $retunData = array('status' => '1', 'message' => 'Success.', 'dataTournament' => $htmlTournament);
    $Config->Close();
