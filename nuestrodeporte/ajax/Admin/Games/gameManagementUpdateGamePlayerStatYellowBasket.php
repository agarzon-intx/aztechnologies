...
unset($__i, $__prev, $__base, $__inc, $__app_here);
    ...
    $YellowP = SanitizeInteger($_POST['YellowP']);
    $YellowT = SanitizeInteger($_POST['YellowT']);

	$retunData = array('status' => '0', 'message' => 'No insert.', 'dataColorAnswer' => 'Error');
		
	$sql = "CALL $schema.GameUpdateDetailYellowBasket('" . $_SESSION[$Config->getAlias() . 'username'] . "', $Player, $Team, $Game, $Week, $Season, $YellowP, $YellowT, @out);";
