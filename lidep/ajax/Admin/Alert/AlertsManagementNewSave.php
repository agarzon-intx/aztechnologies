...
unset($__i, $__prev, $__base, $__inc, $__app_here);
	...
	$sql1 = "CALL $schema.AlertCreate('" . $_SESSION[$Config->getAlias() . 'username'] . "', '$Titulo', '$Inicio', '$Fin', $Status, '$alert', $mostrar, @out);";
	...
	if ($result->num_rows > 0) {
		...
		while($row2 = $result->fetch_assoc()) {
			$retunData = array('status' => '1', 'message' => 'Success.', 'dataAlertAnswer' => $lang['413'], 'sql1' => $sql1, 'sql2' => $sql2);
		}
	}
