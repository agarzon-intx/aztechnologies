<?php
	...
	$sql = "select a.*, concat(a.Torneo_ID,'-', a.Equipo_ID) newLogo from $schema.Equipos a
		join (select max(Torneo_ID) Torneo_ID, Equipo_ID from $schema.Equipos where Torneo_ID = " . $Season . "
